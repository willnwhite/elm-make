...
data Constraint
    = Range Pkg.Version Op Op Pkg.Version
...
isSatisfied :: Constraint -> Pkg.Version -> Bool
...
toString constraint =
  case constraint of
    Range lower lowerOp upperOp upper ->
      unwords
        [ Pkg.versionToString lower
        , opToString lowerOp
        , "v"
        , opToString upperOp
        , Pkg.versionToString upper
        ]
